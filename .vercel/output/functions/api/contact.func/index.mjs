...
async function handler(req, res) {
  ...
  const message = `
\u{1F525} <b>New Lead from TikTok Ads Agency</b> \u{1F525}

\u{1F464} <b>Name:</b> ${name}
\u{1F4E7} <b>Email:</b> ${email}
\u{1F4B0} <b>Budget:</b> ${budget || "Not specified"}
\u{1F3E2} <b>Business Type:</b> ${businessType || "Not specified"}

\u{1F4DD} <b>Goals & Details:</b>
