  ...
  return (
    <>
      <SEO 
        ...
        description="Everything you need to scale on TikTok, from premium infrastructure to creator‑native ads and hands‑on management." 
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-5 flex flex-col justify-center">
            <FadeIn>
              ...
              <p className="text-on-surface/60 mb-8 leading-relaxed">Stop worrying about random bans and slow reviews. Our agency accounts give you the stability and trust signals you need to scale fast.</p>
              <ul className="space-y-4">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span className="font-medium">Faster Ad Approvals</span>
                </li>
                <li className="flex items-center gap-3">
          ...
          <div className="lg:col-span-7 grid grid-cols-2 gap-4">
            <FadeIn delay={0.1} className="bg-surface-container rounded-xl p-8 flex flex-col justify-end h-64 border border-outline-variant/10 hover:border-primary/30 transition-all group">
              ...
              <p className="text-sm text-on-surface/50 mt-2">Higher spend ceilings from day one.</p>
            </FadeIn>
            ...
            <FadeIn delay={0.3} className="col-span-2 bg-gradient-to-br from-surface-container to-surface-container-low rounded-xl p-8 border border-outline-variant/10 relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-on-surface/60 text-sm max-w-md">Our agency access helps you skip common automated hurdles and get to scale faster.</p>
              </div>
      ...
      <section className="bg-surface-container-low py-32 mb-40 relative">
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn className="text-center max-w-2xl mx-auto mb-20">
            ...
            <p className="text-on-surface/60">Data‑driven testing with hands‑on optimization. We manage the full funnel to maximize ROAS.</p>
          </FadeIn>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <FadeIn delay={0.1} className="glass-card p-10 rounded-xl hover:translate-y-[-8px] transition-all duration-300">
              ...
              <p className="text-on-surface/50 text-sm leading-relaxed mb-6">Pixel, events, and catalog setup that makes tracking and optimization airtight.</p>
            ...
            <FadeIn delay={0.2} className="glass-card p-10 rounded-xl hover:translate-y-[-8px] transition-all duration-300 border-primary/20">
              ...
              <p className="text-on-surface/50 text-sm leading-relaxed mb-6">Clear playbooks for creative testing, budget expansion, and profit‑first scaling.</p>
            ...
            <FadeIn delay={0.3} className="glass-card p-10 rounded-xl hover:translate-y-[-8px] transition-all duration-300">
              ...
              <p className="text-on-surface/50 text-sm leading-relaxed mb-6">Real‑time reporting on CAC, LTV, and creative performance you can act on.</p>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2 order-1 lg:order-2">
            <FadeIn>
              ...
              <p className="text-on-surface/60 mb-8 leading-relaxed">TikTok is content‑first. We produce short‑form ads built to hook fast and convert clean.</p>
              <div className="space-y-6">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-on-surface/50">Hook‑first scripts designed to win the first second.</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  <div className="p-2 bg-surface-container-highest rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-on-surface/50">Native‑style edits that feel made for the For You Page.</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  <div className="p-2 bg-surface-container-highest rounded-lg">
                  ...
                  <div>
                    <h4 className="font-bold">Creator Sourcing</h4>
                    <p className="text-sm text-on-surface/50">Vetted creators across top niches with a conversion track record.</p>
                  </div>
                </div>
              </div>
            </FadeIn>
      ...
      <section className="max-w-7xl mx-auto px-6 mb-40">
        <FadeIn className="bg-gradient-to-r from-surface-container to-surface-container-lowest p-12 md:p-20 rounded-[2rem] border border-outline-variant/10 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <p className="text-on-surface/60 mb-12">TikTok Shop is moving fast. We help you win with product, creator, and ad systems built for scale.</p>
