  ...
  return (
    <>
      <SEO 
        ...
        description="Weekly algorithm shifts, creative trends, and scaling secrets for TikTok Ads. No fluff, just results." 
      />
            ...
            <div className="md:col-span-8 group cursor-pointer" onClick={() => window.location.href = `/blog/${featuredPost.slug}`}>
              ...
              <div className="relative h-[500px] rounded-xl overflow-hidden bg-surface-container-low border border-outline-variant/10">
                ...
                <div className="absolute bottom-0 p-10">
                  ...
                  <p className="text-on-surface/80 text-lg max-w-2xl mb-6">Read our latest featured analysis to stay ahead of the curve.</p>
      ...
      <section className="px-6 py-20 bg-surface-container-low">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
             {postList.map((post, i) => (
                <div className="group cursor-pointer" key={post.slug} onClick={() => window.location.href = `/blog/${post.slug}`}>
                  <FadeIn delay={0.1 * (i + 1)}>
                  <div className="aspect-video rounded-xl overflow-hidden mb-6 bg-surface-container-highest">
                    <img loading="lazy" alt={post.frontmatter?.title || post.slug} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src={post.frontmatter?.image || "https://lh3.googleusercontent.com/aida-public/AB6AXuA-c8H5JzkGzz3GtoHNA3spTEH4mDQBny32VQm9MpD71V76JdCwnvNlzwocDX79iPgIwEICyIR9C15ynuHguqdJYACRfFIrbValo3eVyBhKltPWUPxO5NQbHcUiFMY5dEZ-yjXWQkxxd5ZYozUBNGxHQpFwXGbPPm5O2OTT4qCFxRRQVWiaIsgRWPuMPeXxnnz3jS_xxJGGYbXXcc08H-5OdLqj2hvmKvXWS7F-opH1QikkS0L3azllCrjLbwiKskh22tGCCmRPIXQ"}/>
                  </div>
                  ...
                  <p className="text-on-surface/70 text-sm leading-relaxed line-clamp-2">Click to read more...</p>
                  </FadeIn>
                </div>
             ))}
          </div>
